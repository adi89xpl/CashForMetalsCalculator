...
public class DisplayCustomerModel_btnSearch_Handler implements ActionListener {
    private JFrame mainFrame;
    private JTextField Search;
    public DisplayCustomerModel_btnSearch_Handler(JFrame mFrame, JTextField s){
        mainFrame = mFrame;
        Search = s;
    }
    ...
    public void actionPerformed(ActionEvent e){
        ...
        GUIHelper.SetDisplay(mainFrame, displayFrame.getDisplayPanel(), "Display Customer");
    }
}
